...
import (
	...
	"github.com/nginxinc/nginx-ingress-operator/pkg/controller"
	"github.com/nginxinc/nginx-ingress-operator/version"
...
func main() {
	...
	err = leader.Become(ctx, "nginx-ingress-operator-lock")
	if err != nil {
		log.Error(err, "")
		os.Exit(1)
	}
	...
	sccAPIExists, err := nginxingresscontroller.VerifySCCAPIExists()
	if err != nil {
		log.Error(err, "Could not check if SCC API exists")
		os.Exit(1)
	}
